...
public class AmazonClientManager {
    ...
    public boolean hasCredentials() {
        return (!(Constants.IDENTITY_POOL_ID.equalsIgnoreCase("us-east-2:8f7fe1b0-9ccc-46af-9798-adcf10811788")
                || Constants.TEST_TABLE_NAME.equalsIgnoreCase("Lightcontrol")));
    }
